 ...
 * @see veinthrough.test._class.Manager
 * <p>---------------------------------------------------------
 * <pre>
 * Tests contains:
   ...
   13.[Employee.equals()][Manager.equals()]子类拥有自己的相等概念，
               则对称性需求将强制采用getClass检测而不能用instanceof
   14.[Employee.equals2()]因为不需要再子类中改变语义，由父类决定相等概念，
...
public class DerivedTest extends AbstractUnitTester{
    ...
    private void polymorphismTest() {
        ...
        //然后staffs中一半是Employee，一般是Manager
